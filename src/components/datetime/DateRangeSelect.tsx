...
export default function DateRangeSelect({ t, createDateTime }: { t: TFunction; createDateTime: UseDateTimeState }) {
  ...
  return (
    <DateColumnBox>
      ...
      <Box sx={{ position: 'relative' }}>
        <DateIconBox />
        <DatePicker
          selected={timeValues.endDate}
          onChange={handleChangeTimeValues('endDate')}
          selectsEnd
          startDate={timeValues.startDate}
          endDate={timeValues.endDate}
          minDate={timeValues.startDate}
          dateFormat="yyyy/MM/dd"
        />
      </Box>
    </DateColumnBox>
